...
\title{GUIDELINES FOR AUTHORS PREPARING MANUSCRIPTS FOR PUBLICATION IN THE THE LAGIRS 2020 CONFERENCE}
...
\abstract{
These guidelines are provided for preparation of papers accepted for publication in the proceedings of LAGIRS 2020 – the Latin American GRSS and ISPRS Remote Sensing Conference. These guidelines are valid for publication in both, the ISPRS Archives and Annals, and in IEEE Xplore. They are issued to ensure a uniform style throughout these two series. All papers that are accepted by the relevant scientific committee will be published provided they arrive by the due date and they are in strict conformance with these guidelines. The LAGIRS organisers may omit any paper that does not conform to the specified requirements. \textbf{There will be no opportunity for corrections or improvements of poorly prepared originals}.  
}

\keywords{Manuscripts, LAGIRS, Guidelines for Authors, Style guide}
