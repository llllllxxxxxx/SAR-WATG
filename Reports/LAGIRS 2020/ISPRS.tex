...
\begin{document}
	...
	%%%\todo[inline]{Ainda não gostei dos parágrafos acima, vê se o texto em vermelho ficou melhor} (Resolvido)
	...
	%%%\textcolor{violet}{Ilustrar com uma s\'erie interessante, com diversas transi\c c\~oes}(RESOLVIDO)
	...
	%%%\todo[inline]{Tente dar uma noção do que ficou melhor nos seus estudos em termos de  $m$ e $\tau$ para chegarmos a uma conclusão}(RESOLVIDO)
