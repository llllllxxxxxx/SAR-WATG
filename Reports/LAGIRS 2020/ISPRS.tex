...
Experimental with data from Munich urban areas, Guatemala forest regions, and Cape Canaveral ocean samples demonstrate the effectiveness of our technique, which achieves satisfactory levels of separability.
}
...
%and previous algorithms have also used the statistical characteristics of the data in the classification process~\citep{Lee1992Wishart}.
...
\end{sidewaysfigure*}
	...
	\bibliography{../../Common/ImageAnalysisIT,../../Common/references,../../Common/sar}
