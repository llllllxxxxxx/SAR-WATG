...
# FGPE.R
#
# Analysis of SAR images using Fine-grained permutation entropy
#
...
FGPE <- function(series, dimension, delay, p.alpha){
...
FGPE.analysis <- function(p.alpha){
  ...
  write.csv(Entropy.Complexity,'../Data/EntropyComplexityFGPET1A05.csv', row.names = FALSE)
  
}

FGPE.analysis(p.alpha = 0.5)