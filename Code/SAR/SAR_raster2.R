...
# SAR_raster2.R
#
# Analysis of the SAR images using Raster-2 curves 
#
...
SAR.Raster2.Analysis <- function(Analysis){
  ...
  if(Analysis == 1){ #Analysis of SAR characterization
    for(i in 1:(length(n)*length(tal))){
      ...
      for(j in c(1:ns.guatemala)){
        ...
        get.serie <- formationPatternsTexturesVertical(img, n[a], tal[b], xy)
      ...
      for(j in c(1:ns.canaveral.behavior1)){
        ...
        probability[ns.guatemala + j, 1:factorial(n[a])] <- Bandt.Pompe(as.vector(t(my.elements)), n[a], dim(get.serie)[3])
      }
      ...
      for(j in c(1:ns.canaveral.behavior2)){
        ...
        probability[(ns.canaveral.behavior1 + ns.guatemala) + j, 1:factorial(n[a])] <- Bandt.Pompe(as.vector(t(my.elements)), n[a], dim(get.serie)[3])
      }
      #Munich
      ...
      for(j in c(1:ns.munich)){
        ...
        probability[(ns.canaveral.behavior1 + ns.canaveral.behavior2 + ns.guatemala) + j, 1:factorial(n[a])] <- Bandt.Pompe(as.vector(t(my.elements)), n[a], dim(get.serie)[3])
      }
    ...
    ggarrange(plots[[1]], plots[[2]], plots[[3]], plots[[4]], plots[[5]],
      ...
      ggtitle(expression(italic("SAR Images - Raster-2 Analysis"))) +
    ...
    ggarrange(plots[[1]], plots[[2]], plots[[3]], plots[[4]], plots[[5]],
              ...
              plots[[16]], plots[[17]], plots[[18]], plots[[19]], plots[[20]],
              ncol=5, nrow=4, common.legend = TRUE, legend = "right") + 
      ggtitle(expression(italic("Guatemala Region - Raster-2 Analysis"))) +
      xlab(expression(italic(H))) + ylab(expression(italic(C))) + labs(colour=expression(italic(Regions))) +
      theme_igray() + theme(text=element_text(size=14, family="Times New Roman"), axis.text.x=element_blank(), axis.text.y=element_blank(),plot.title = element_text(hjust=0.5)) + 
      guides(colour = guide_legend(override.aes = list(size=3)))
  }
    ...
    for(i in 1:(length(n)*length(tal))){
      ...
      for(j in c(1:ns.canaveral.behavior2)){
        ...
        probability[(ns.canaveral.behavior1) + j, 1:factorial(n[a])] <- Bandt.Pompe(as.vector(t(my.elements)), n[a], dim(get.serie)[3])
      }
    ...
    ggarrange(plots[[1]], plots[[2]], plots[[3]], plots[[4]], plots[[5]],
              ...
              plots[[16]], plots[[17]], plots[[18]], plots[[19]], plots[[20]],
              ncol=5, nrow=4, common.legend = TRUE, legend = "right") + 
      ggtitle(expression(italic("Cape Canaveral Region - Raster-2 Analysis"))) +
      xlab(expression(italic(H))) + ylab(expression(italic(C))) + labs(colour=expression(italic(Regions))) +
      theme_igray() + theme(text=element_text(size=14, family="Times New Roman"), axis.text.x=element_blank(), axis.text.y=element_blank(),plot.title = element_text(hjust=0.5)) + 
      guides(colour = guide_legend(override.aes = list(size=3)))
  }
    ...
    ggarrange(plots[[1]], plots[[2]], plots[[3]], plots[[4]], plots[[5]],
              ...
              plots[[16]], plots[[17]], plots[[18]], plots[[19]], plots[[20]],
              ncol=5, nrow=4, common.legend = TRUE, legend = "right") + 
      ggtitle(expression(italic("Munich Region - Raster-2 Analysis"))) +
      xlab(expression(italic(H))) + ylab(expression(italic(C))) + labs(colour=expression(italic(Regions))) +
      theme_igray() + theme(text=element_text(size=14, family="Times New Roman"), axis.text.x=element_blank(), axis.text.y=element_blank(),plot.title = element_text(hjust=0.5)) + 
      guides(colour = guide_legend(override.aes = list(size=3)))
  }
...
SAR.Raster2.Analysis(1)
SAR.Raster2.Analysis(2)
SAR.Raster2.Analysis(3)
SAR.Raster2.Analysis(4)