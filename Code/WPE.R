...
# WPE.R
#
# Analysis of SAR images using weighted permutation entropy
#
...
WPE.analysis <- function(){
  ...
  write.csv(Entropy.Complexity,'../Data/EntropyComplexityWPED3T1.csv', row.names = FALSE)
