...
# AAPE.R
#
# Analysis of SAR images using amplitude-aware permutation entropy
#
...
AAPE <- function(series, dimension, delay, A){
...
AAPE.analysis <- function(A){
  ...
  write.csv(Entropy.Complexity,'../Data/EntropyComplexityAAPED3T1A1.csv', row.names = FALSE)
